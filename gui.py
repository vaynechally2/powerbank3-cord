...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        top.addWidget(QLabel("Target URL"), 0, 0)
        top.addWidget(self.url_edit, 0, 1, 1, 3)
        top.addWidget(QLabel("Detection mode"), 1, 0)
        top.addWidget(self.rule_mode, 1, 1)
        top.addWidget(QLabel("Selector / text"), 1, 2)
        ...
        schedule_grid.addWidget(QLabel("Clock offset sec"), 3, 0)
