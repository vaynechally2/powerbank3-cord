...
3) Enter target URL.
4) Choose detection mode and value.
5) Set refresh seconds (minimum 1 second).
6) Set clock offset:
...
7) Optional: upload reference image and test image match.
7b) Use Target Helper / Inspect Paste to analyze pasted selector/HTML/SVG/XPath text.
8) Set active days/time.
9) Click Save Profile, then Start.
...
Troubleshooting
---------------
- "Brave was not found": install Brave or verify path.
